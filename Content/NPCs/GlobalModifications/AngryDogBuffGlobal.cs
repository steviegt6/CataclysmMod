...
namespace CataclysmMod.Content.NPCs.GlobalModifications
{
    public class AngryDogBuffGlobal : GlobalNPC
    {
        ...
        public override void NPCLoot(NPC npc) => DropHelper.DropItemCondition(npc, ModContent.ItemType<Cryophobia>(), CalamityChangesConfig.Instance.angryDogSpawnBuff, 0.15f);
